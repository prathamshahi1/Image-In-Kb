        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 text-xs">
          <div className="space-y-2.5">
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-400">
              ...
              <li><Link to="/edit" className="hover:text-indigo-600 dark:hover:text-white transition-colors">Crop & Edit Photo</Link></li>
              ...
              <li><Link to="/pdf-to-image" className="hover:text-indigo-600 dark:hover:text-white transition-colors">PDF to Image (JPG/PNG)</Link></li>
            </ul>
          </div>
